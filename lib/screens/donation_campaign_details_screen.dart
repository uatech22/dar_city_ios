...
class _DonationCampaignDetailsScreenState extends State<DonationCampaignDetailsScreen>
  ...
  void initState() {
    ...
    startAutoRefresh(_reloadTopDonors);
  }

  Future<void> _reloadTopDonors() async {
    final future = DonationService().getTopDonors(widget.campaign.id);
    setState(() => _topDonorsFuture = future);
    await future;
  }
